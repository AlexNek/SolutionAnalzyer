...
namespace SolutionAnalyzer.Roslyn_analyzers
{
    ...
    {
        internal static readonly ComputationalComplexityMetrics Default = new ComputationalComplexityMetrics(0, 0, 0, 0, 0, 
        ImmutableHashSet<OperationKind>.Empty,
        ImmutableHashSet<BinaryOperatorKind>.Empty, 
        ImmutableHashSet<UnaryOperatorKind>.Empty, 
        ImmutableHashSet<CaseKind>.Empty, 
            ...
            ImmutableHashSet<object> distinctReferencedConstants)
        {
            ...
            return new ComputationalComplexityMetrics(
                ...
                effectiveLinesOfMaintainableCode,
                operatorUsageCounts,
                symbolUsageCounts,
                constantUsageCounts,
                distinctOperatorKinds,
                distinctBinaryOperatorKinds,
                distinctUnaryOperatorKinds,
                distinctCaseKinds,
                distinctReferencedSymbols,
        ...
        public static ComputationalComplexityMetrics Compute(IOperation operationBlock)
        {
            ...
            return Create(
                ...
                distinctBinaryOperatorKindsBuilder != null
                    ? distinctBinaryOperatorKindsBuilder.ToImmutable()
                    : ImmutableHashSet<BinaryOperatorKind>.Empty,
                distinctUnaryOperatorKindsBuilder != null
                    ? distinctUnaryOperatorKindsBuilder.ToImmutable()
                    : ImmutableHashSet<UnaryOperatorKind>.Empty,
            ...
            static bool hasAnyExplicitExpression(IOperation operation)
            {
                ...
                return !operation.DescendantsAndSelf()
                           .All(o => o.IsImplicit || (!o.ConstantValue.HasValue && o.Type == null && o.Kind != OperationKind.Branch));
            }
