...
namespace SolutionAnalyzer.Roslyn_analyzers
{
    internal static class MetricsHelper
    {
        ...
        internal static void AddCoupledNamedTypes(
        ...
        internal static async Task<long> GetLinesOfCodeAsync(
            ...
            CodeMetricsAnalysisContext context)
        {
            ...
            foreach (var decl in declarations)
            {
                ...
                else
                {
                    ...
                    var additionalNewLines = Math.Max(
                        0,
                        GetNewlineCount(declSyntax.GetLeadingTrivia(), leading: true)
                        + GetNewlineCount(declSyntax.GetTrailingTrivia(), leading: false) - 1);
        ...
        internal static async Task<SyntaxNode> GetTopmostSyntaxNodeForDeclarationAsync(
        ...
        internal static async Task<(int cyclomaticComplexity, ComputationalComplexityMetrics computationalComplexityMetrics)>
            ComputeCoupledTypesAndComplexityExcludingMemberDeclsAsync(
                ImmutableArray<SyntaxReference> declarations,
                ISymbol symbol,
                ImmutableHashSet<INamedTypeSymbol>.Builder builder,
                CodeMetricsAnalysisContext context)
        {
            ...
            foreach (var declaration in declarations)
            {
                ...
                foreach (var attribute in attributes)
                {
                    ...
                    {
                        var attributeSyntax = await attribute.ApplicationSyntaxReference.GetSyntaxAsync(context.CancellationToken)
        ...
        private static void AddCoupledNamedTypesCore(
            ImmutableHashSet<INamedTypeSymbol>.Builder builder,
            ITypeSymbol typeOpt,
            WellKnownTypeProvider wellKnownTypeProvider)
        {
            ...
            static bool isIgnoreableType(INamedTypeSymbol namedType, WellKnownTypeProvider wellKnownTypeProvider)
            {
                ...
                {
                    case SpecialType.System_Boolean or SpecialType.System_Byte or SpecialType.System_Char or SpecialType.System_Double or
                        SpecialType.System_Int16 or SpecialType.System_Int32 or SpecialType.System_Int64 or SpecialType.System_UInt16 or
                        SpecialType.System_UInt32 or SpecialType.System_UInt64 or SpecialType.System_IntPtr or SpecialType.System_UIntPtr or
                        SpecialType.System_SByte or SpecialType.System_Single or SpecialType.System_String or SpecialType.System_Object or SpecialType
                            .System_ValueType or SpecialType.System_Void:
                        return true;
                    default:
                        return namedType.IsAnonymousType || namedType.GetAttributes()
                                   .Any(
